...
#include <memory>
#include "../Server/fillintheblanksquestion.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FillInTheBlanksQuestion_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FillInTheBlanksQuestion_t qt_meta_stringdata_FillInTheBlanksQuestion = {
    {
QT_MOC_LITERAL(0, 0, 23) // "FillInTheBlanksQuestion"
...
static const uint qt_meta_data_FillInTheBlanksQuestion[] = {
...
QT_INIT_METAOBJECT const QMetaObject FillInTheBlanksQuestion::staticMetaObject = { {
    QMetaObject::SuperData::link<iQuestion::staticMetaObject>(),
    qt_meta_stringdata_FillInTheBlanksQuestion.data,
