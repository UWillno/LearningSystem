...
#include <memory>
#include "../../../Server-cmake/trueorfalsequestion.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TrueOrFalseQuestion_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TrueOrFalseQuestion_t qt_meta_stringdata_TrueOrFalseQuestion = {
    {
        QT_MOC_LITERAL(0, 19)   // "TrueOrFalseQuestion"
    },
    "TrueOrFalseQuestion"
};
...
Q_CONSTINIT static const uint qt_meta_data_TrueOrFalseQuestion[] = {
...
Q_CONSTINIT const QMetaObject TrueOrFalseQuestion::staticMetaObject = { {
    QMetaObject::SuperData::link<iQuestion::staticMetaObject>(),
    qt_meta_stringdata_TrueOrFalseQuestion.offsetsAndSizes,
    qt_meta_data_TrueOrFalseQuestion,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TrueOrFalseQuestion_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TrueOrFalseQuestion, std::true_type>
    >,
    nullptr
} };
