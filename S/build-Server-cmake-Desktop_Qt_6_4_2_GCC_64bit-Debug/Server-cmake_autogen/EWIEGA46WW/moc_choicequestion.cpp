...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ChoiceQuestion_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ChoiceQuestion_t qt_meta_stringdata_ChoiceQuestion = {
    {
        QT_MOC_LITERAL(0, 14)   // "ChoiceQuestion"
    },
    "ChoiceQuestion"
};
...
Q_CONSTINIT static const uint qt_meta_data_ChoiceQuestion[] = {
...
Q_CONSTINIT const QMetaObject ChoiceQuestion::staticMetaObject = { {
    QMetaObject::SuperData::link<iQuestion::staticMetaObject>(),
    qt_meta_stringdata_ChoiceQuestion.offsetsAndSizes,
    qt_meta_data_ChoiceQuestion,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ChoiceQuestion_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ChoiceQuestion, std::true_type>
    >,
    nullptr
} };
